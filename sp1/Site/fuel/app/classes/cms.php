...
// 	        array('title' => 'Dashboard', 	'icon' => 'icons/mainnav/dashboard.png', 	'url' => Uri::create('dashboard/agenda')),
			array('title' => 'Offerss', 		 'icon' => 'icons/mainnav/deals.png', 		 'url' => Uri::create('dashboard/offers?gallery=1')),
			array('title' => 'Eventss', 		 'icon' => 'icons/mainnav/events.png', 	 'url' => Uri::create('dashboard/events?gallery=1')),
		);
