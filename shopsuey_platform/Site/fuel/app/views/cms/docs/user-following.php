<div id="doc-content" class="mt20">
    <h1><a id="user-reset"></a>User - Following</h1>
    <p>Retrieves the list of following users for the defined user.</p>
    ...
    <h4>Endpoint</h4>
    <pre class="code"><?= Uri::create('api/user/id/following') ?></pre>
    <br>
    ...
    <h4>Example</h4>
    <pre class="code"><?= Uri::create('api/user/180/following') ?></pre>
    <br>
