...
/**
 * This is an exact clone of the SimpleAcl driver, but the name of the config file is changed
 * @author lucas
 *
 */

class Auth_Acl_Shopsuey extends \Auth_Acl_Driver
{
	...
	{
		static::$_valid_roles = array_keys(\Config::get('shopsueyauth.roles'));
	}
	...
	public function has_access($condition, Array $entity)
	{
		...
		{
			$roles = \Config::get('shopsueyauth.roles', array());
